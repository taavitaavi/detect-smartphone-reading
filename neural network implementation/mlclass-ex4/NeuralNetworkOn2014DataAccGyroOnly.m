...
input_layer_size  = 6;  % x,y,z  and xyz moving standard deviationfrom accelerometer
...
datapoints=loadData();
X = datapoints(:, [ 1, 2 ,3, 4, 5 , 6]); y =datapoints(:, 13);
...
validationData=validationSet(:, [ 1, 2, 3, 4, 5 , 6]); validationLabels =validationSet(:, 13);
...
testData=testSet(:, [ 1, 2, 3, 4, 5 , 6]); testLabels =testSet(:, 13);
